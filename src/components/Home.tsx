...
export const Home: React.FC<HomeProps> = ({
  ...
  return (
    <div className="relative space-y-24 pb-16">
      ...
      {/* =========================================================
          TACTICAL SCROLL TRACKER - SOVIET JET SYSTEM (SU-57)
          ========================================================= */}
      <div 
        className="fixed left-5 lg:left-[5%] xl:left-[7%] top-[30%] z-40 pointer-events-none hidden md:flex flex-col items-center gap-4 transition-all duration-300"
      >
        {/* Tactical trajectory guide dashed line */}
        <div className="absolute top-[-300px] bottom-[-300px] w-[2px] bg-gradient-to-b from-cyan-500/0 via-cyan-500/35 to-cyan-500/0 dash-line z-0" />
        ...
        <div 
          className="bg-[#0b0f1d]/90 border border-cyan-500/30 rounded-xl p-3 font-mono text-[10px] text-cyan-400 space-y-1.5 backdrop-blur-md shadow-xl w-36 z-10 transition-all duration-300"
        >
          ...
          <div className="border-t border-cyan-500/10 pt-1 text-[8px] text-slate-400">
