    ...
    <div className="space-y-16 pb-12">
      ...
      <div className="relative rounded-2xl overflow-hidden bg-[#0d1527] border border-slate-800 p-8 sm:p-12 shadow-2xl flex items-center min-h-[250px]">
        ...
        <div className="relative z-10 max-w-2xl space-y-3">
          <span className="text-xs font-bold text-cyan-400 font-mono uppercase tracking-widest">Company Overview</span>
          <h2 className="text-3xl font-bold font-display text-white tracking-tight">Our Aerospace Heritage</h2>
      ...
      <div className="space-y-6">
        <h3 className="text-xl font-bold font-display text-white text-center">Quality Assurance Laboratory</h3>
        <p className="text-slate-400 text-xs sm:text-sm text-center max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
          <div className="bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-3">
            ...
            <h4 className="text-white text-xs font-bold uppercase tracking-wider font-mono">MIL-STD-202 Tested</h4>
          ...
          <div className="bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-3">
            ...
            <h4 className="text-white text-xs font-bold uppercase tracking-wider font-mono">10,000V Isolation vacuum</h4>
            <p className="text-slate-400 text-xs leading-relaxed">
          ...
          <div className="bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-3">
            ...
            <h4 className="text-white text-xs font-bold uppercase tracking-wider font-mono">Laser seal inspection</h4>
            <p className="text-slate-400 text-xs leading-relaxed">
