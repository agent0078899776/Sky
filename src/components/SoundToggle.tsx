...
export const SoundToggle: React.FC<SoundToggleProps> = ({ theme, isMuted, onToggle }) => {
  ...
  return (
    <div 
      className="fixed right-5 top-[42%] -translate-y-1/2 z-50 flex flex-col items-center gap-2 group"
    ...
    >
      ...
      <button 
        ...
        className={`relative w-11 h-11 rounded-full border cursor-pointer select-none transition-all duration-500 shadow-2xl flex items-center justify-center group/btn focus:outline-none ${
          isDark 
            ? "bg-slate-950/90 border-slate-805 hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(6,182,212,0.15)] shadow-black/85" 
